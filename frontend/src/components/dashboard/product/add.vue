    ...
    <form @submit.prevent="add" enctype="multipart/form-data">
      <div class="wrapper-input row row-cols-sm-2">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="product_title" id="product_title" class="form-control" placeholder="Nhập tiêu đề"
            v-model="data.product_title" :class="{ 'is-invalid': errors.product_title }" aria-describedby="helpId">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="product_name" id="product_name" class="form-control" placeholder="Nhập tên sản phẩm"
            v-model="data.product_name" :class="{ 'is-invalid': errors.product_name }" aria-describedby="helpId">
        ...
        <div class="mb-3">
          ...
          <input type="number" name="product_price" id="product_price" class="form-control" placeholder="Nhập giá sản phẩm (9999)"
            v-model="data.product_price" :class="{ 'is-invalid': errors.product_price }" aria-describedby="helpId">
        ...
        <div class="mb-3">
          ...
          <select class="form-select form-select-md" name="product_memory" id="product_memory"
            ...
            <option value="64GB">640GB</option>
        ...
        <div class="mb-3">
          ...
          <select class="form-select form-select-md" name="product_ram" id="product_ram" v-model="data.product_ram"
            :class="{ 'is-invalid': errors.product_ram }">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="product_amount" id="product_amount" class="form-control" placeholder="Nhập số lượng"
            v-model="data.product_amount" :class="{ 'is-invalid': errors.product_amount }" aria-describedby="helpId">
        ...
        <div class="mb-3">
          ...
          <input type="text" list="datalist" name="product_category" id="product_category" class="form-control"
            v-model="data.product_category" :class="{ 'is-invalid': errors.product_category }" placeholder="Hãng sản xuất"
...
function add() {
  ...
  ax.post("admin/product", formData, { headers: { "Content-Type": "multipart/form-data" } })
    .then((response) => {
        emits("notification",response.data.message)
    })
    .catch((error) => {
